...
public class Add3DModel : MonoBehaviour
{
    ...
    public void Spawn3DModel()
    {
        ...
        if (objModel != null)
        {
            ...
            // Notify other systems that a new CAD model was imported
            AddCommand addCommandScript = FindFirstObjectByType<AddCommand>();
            if (addCommandScript != null)
            {
                addCommandScript.RefreshObjectDropdowns();
            }
